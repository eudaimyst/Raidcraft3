		...
		override public function update():void 
		{
			...
			if (this.collide(GC.TYPE_MOUSE, x, y))
			{
				...
				if (Input.mousePressed)
				{
					...
					loginInstance.getphp(attachedUserInput.textGraphic.text, attachedPassInput.textGraphic.text, attachedPassConfirmInput.textGraphic.text, attachedEmailInput.textGraphic.text); //run phpLogin.getphp with attached lineinput instance's textGraphic.text value
